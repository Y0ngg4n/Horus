...
self-hosted Kubernetes cluster. It can scan all your Ingress to provide them via the page and does even support sub-pages.
Thanks to Hajimari for the great inspiration!
